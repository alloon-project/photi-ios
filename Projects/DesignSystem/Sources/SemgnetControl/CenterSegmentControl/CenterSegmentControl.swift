...
/*
 public final class DashLineSegmentControl: PhotiSegmentControl {
   ...
   override func setupSegmentControl(with items: [String]) {
     removeAllSegment()
 ...
 // MARK: - UI Methods
 private extension DashLineSegmentControl {
   func setViewHierarchy() {
 ...
 private extension DashLineSegmentControl {
   ...
   func segmentButton(title: String, tag: Int) -> DashLineSegmentButton {
